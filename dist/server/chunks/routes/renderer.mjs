...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Bhumisparsha School — Arte, Dharma, Meio Ambiente e Tecnologia no Cyberpunk Magico."},{"name":"theme-color","content":"#000000"},{"property":"og:title","content":"Bhumisparsha School | Cyber Dharma"},{"property":"og:description","content":"Arte, Dharma, Meio Ambiente e Tecnologia."},{"property":"og:type","content":"website"},{"property":"og:url","content":"https://bhumisparshaschool.org"}],"link":[{"rel":"icon","type":"image/png","href":"/images/logo.png"}],"style":[],"script":[],"noscript":[],"title":"Bhumisparsha School | Cyber Dharma","htmlAttrs":{"lang":"pt-BR"}};
...
const getServerEntry = () => import('../virtual/entry.mjs').then(function (n) { return n.x; }).then((r) => r.default || r);
...
const entryFileName = "DrJ83qXZ.js";
